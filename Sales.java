...
/********************************************************************************************/
 ...
 System.out.println("PLEASE ENTER \"(e)\" FOR EMPLOYER, \"(s)\" FOR SALES PERON OR \"(x)\" TO EXIT: ");
 choice = scan.nextLine();
  ...
  switch (choice)
   ...
   case "E":
      {
       System.out.println("PLEASE ENTER THE NUMBER OF EMPLOYEES THAT YOU WISH TO PROCESS: ");
	    int esize = scan.nextInt();
       scan.nextLine();

      if (esize<1 || esize >10)//error checks for range
      {    
          System.out.println("The value that you entered is incorrect! Please try again!");
            break;
          }
	   ...
	   for (int i = 0; i<employees.length;i++)
	       {
		     ...
		     employees[i] = new Employee(name,id,hoursWorked,hourlyRate);//stores data into array
    ...
    case "S":
         {
           ...
           System.out.println("PLEASE ENTER THE NUMBER OF SALES PEOPLE THAT YOU WISH TO PROCESS: ");
