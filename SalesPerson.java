...
public class SalesPerson
{
   ...
   private double sales;
	...
	public SalesPerson(String str0, int str1, double sales1, double commisionR)//constructor
	{
		name = str0;
		id = str1;
		sales = sales1;
	...
	public String toString()
	{
		...
		return name + "\t\t" + fmt2.format(id) + "\t\t" + sales + "\t\t" + commisionRate +"%" + "\t\t"+ commision();//returns the values
	}
}
